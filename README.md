...
RNAseq/
    ├── Data1.RNAseq/
        ...
        ├── feature_counts/
            ...
            ├── Data1.RNAseq.mm10.featureCounts.gene.txt                       #This output is sufficient if you do regular gene expression analysis
        ...
        ├── salmon_results/
            ├── Data1.RNAseq.mm10.quant.sf                                      #salmon quantification result
